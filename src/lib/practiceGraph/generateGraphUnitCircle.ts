      ...
      steps: [
        {
          ...
          text: 'First identify the unit-circle coordinates for this exact angle. On the unit circle, the point is (x,y)=(cosθ,sinθ).',
        },
        {
          katex: String.raw`\cos\theta = ${angle.cosLatex},\quad \sin\theta = ${angle.sinLatex}`,
          text: 'So we now know the exact values of cosθ and sinθ for this angle.',
        },
        {
          katex: (() => {
            if (ask === 'sin') return String.raw`\sin\theta = y`;
            if (ask === 'cos') return String.raw`\cos\theta = x`;
            if (ask === 'tan') return String.raw`\tan\theta = \frac{\sin\theta}{\cos\theta}`;
            if (ask === 'cot') return String.raw`\cot\theta = \frac{\cos\theta}{\sin\theta}`;
            if (ask === 'sec') return String.raw`\sec\theta = \frac{1}{\cos\theta}`;
            return String.raw`\cosec\theta = \frac{1}{\sin\theta}`;
          })(),
          text: 'Write the definition of the required trigonometric ratio.',
        },
        {
          katex: (() => {
            if (ask === 'sin') return String.raw`\sin\theta = ${angle.sinLatex}`;
            if (ask === 'cos') return String.raw`\cos\theta = ${angle.cosLatex}`;
            if (ask === 'tan') return String.raw`\tan\theta = \frac{${angle.sinLatex}}{${angle.cosLatex}}`;
            if (ask === 'cot') return String.raw`\cot\theta = \frac{${angle.cosLatex}}{${angle.sinLatex}}`;
            if (ask === 'sec') return String.raw`\sec\theta = \frac{1}{${angle.cosLatex}}`;
            return String.raw`\cosec\theta = \frac{1}{${angle.sinLatex}}`;
          })(),
          text: 'Substitute the exact values of sinθ and cosθ from the unit circle into the definition.',
        },
        ...((() => {
          // Add micro-steps for ratios that require algebraic manipulation.
          const sin = angle.sinLatex;
          const cos = angle.cosLatex;

          if (computed.undefined) {
            const denom = ask === 'tan' || ask === 'sec' ? cos : ask === 'cot' || ask === 'cosec' ? sin : '0';
            return [
              {
                katex: String.raw`\text{Denominator} = ${denom}`,
                text: 'Check the denominator before dividing. If it equals 0, the expression is undefined.',
              },
            ];
          }
          ...
          if (ask === 'tan') {
            return [
              {
                katex: String.raw`\tan\theta = \frac{\sin\theta}{\cos\theta} = \frac{${sin}}{${cos}}`,
                text: 'Write tanθ as a ratio and substitute the exact sinθ and cosθ values.',
              },
              {
                katex: String.raw`\tan\theta = ${correct}`,
                text: 'Simplify the fraction (this may include dividing by a fraction and rationalising if needed).',
              },
            ];
          }
          ...
          if (ask === 'cot') {
            return [
              {
                katex: String.raw`\cot\theta = \frac{\cos\theta}{\sin\theta} = \frac{${cos}}{${sin}}`,
                text: 'Write cotθ as a ratio and substitute the exact cosθ and sinθ values.',
              },
              {
                katex: String.raw`\cot\theta = ${correct}`,
                text: 'Simplify the fraction (this may include dividing by a fraction and rationalising if needed).',
              },
            ];
          }
          ...
          if (ask === 'sec') {
            return [
              {
                katex: String.raw`\sec\theta = \frac{1}{\cos\theta} = \frac{1}{${cos}}`,
                text: 'Write secθ as the reciprocal of cosθ and substitute the exact cosθ value.',
              },
              {
                katex: String.raw`\sec\theta = ${correct}`,
                text: 'Simplify (this may require rationalising the denominator).',
              },
            ];
          }
          ...
          if (ask === 'cosec') {
            return [
              {
                katex: String.raw`\cosec\theta = \frac{1}{\sin\theta} = \frac{1}{${sin}}`,
                text: 'Write cosecθ as the reciprocal of sinθ and substitute the exact sinθ value.',
              },
              {
                katex: String.raw`\cosec\theta = ${correct}`,
                text: 'Simplify (this may require rationalising the denominator).',
              },
            ];
          }
        ...
        {
          katex: (() => {
            if (!computed.undefined) return String.raw`${askLatex}(\theta) = ${correct}`;
            return String.raw`${askLatex}(\theta)\ \text{is undefined}`;
          })(),
          text: computed.undefined
            ? 'If the denominator is 0, the ratio is undefined (division by 0).'
            : 'Now simplify the expression to get the exact value.',
        },
        ...(computed.undefined
          ? []
          : [
              {
                katex: String.raw`\boxed{${askLatex}(\theta) = ${correct}}`,
                text: 'Final answer.',
              },
            ]),
      ],
