...
export const MATH_ONTOLOGY_SEED: OntologySeed[] = [
  tag('subject.mathematics', 'Mathematics', 'topic', 'Problems involving numbers, algebra, geometry, calculus, probability, and quantitative reasoning.', undefined, ['গণিত', 'গণিতশাস্ত্র', 'गणित']),
  tag('subject.physics', 'Physics', 'topic', 'Problems about motion, forces, energy, waves, electricity, magnetism, and physical laws.', undefined, ['পদার্থবিজ্ঞান', 'भौतिकी', 'भौतिक विज्ञान']),
  tag('subject.chemistry', 'Chemistry', 'topic', 'Problems about matter, atoms, molecules, reactions, stoichiometry, bonding, and chemical properties.', undefined, ['রসায়ন', 'রসায়ন', 'रसायन विज्ञान', 'रसायन']),
  tag('subject.biology', 'Biology', 'topic', 'Questions about living organisms: cells, genetics, evolution, physiology, ecology, and life processes.', undefined, ['জীববিজ্ঞান', 'जीवविज्ञान', 'जीव विज्ञान']),
  tag('subject.english', 'English', 'topic', 'Language, grammar, comprehension, writing skills, vocabulary, and literary analysis.', undefined, ['ইংরেজি', 'अंग्रेज़ी', 'अंग्रेजी']),
  tag('subject.history', 'History', 'topic', 'Questions about historical periods, events, causes, consequences, and chronology.', undefined, ['ইতিহাস', 'इतिहास']),
  tag('subject.evs', 'EVS', 'topic', 'Environmental studies: ecosystems, resources, health, hygiene, community, and sustainability.', undefined, ['পরিবেশ', 'পরিবেশবিদ্যা', 'पर्यावरण अध्ययन', 'पर्यावरण']),
  tag('subject.social_science', 'Social Science', 'topic', 'Civics, geography, economics, and society: institutions, maps, resources, and human systems.', undefined, ['সামাজিক বিজ্ঞান', 'समाज विज्ञान']),

  tag('topic.arithmetic', 'Arithmetic', 'topic', 'Foundational numerical computation with integers, fractions, decimals, and ratios.', 'subject.mathematics', ['পাটিগণিত', 'अंकगणित']),
  ...
  tag('topic.algebra', 'Algebra', 'topic', 'Symbolic manipulation, expressions, equations, and relationships between quantities.', 'subject.mathematics', ['বীজগণিত', 'बीजगणित']),
  ...
  tag('topic.geometry', 'Geometry', 'topic', 'Shapes, measurements, properties of figures, and geometric reasoning.', 'subject.mathematics', ['জ্যামিতি', 'ज्यामिति']),
  ...
  tag('topic.trigonometry', 'Trigonometry', 'topic', 'Trigonometric functions, identities, equations, and applications to angles and periodic behavior.', 'subject.mathematics', ['ত্রিকোণমিতি', 'त्रिकोणमिति']),
  ...
  tag('topic.calculus', 'Calculus', 'topic', 'Limits, derivatives, integrals, and reasoning about change and accumulation.', 'subject.mathematics', ['কলন', 'सांकलन', 'कलन']),
  ...
  tag('topic.probability', 'Probability', 'topic', 'Quantifying uncertainty with events, sample spaces, counting, and probabilistic reasoning.', 'subject.mathematics', ['সম্ভাবনা', 'प्रायिकता', 'संभाव्यता']),
  tag('topic.statistics', 'Statistics', 'topic', 'Describing and inferring from data using measures, distributions, and models.', 'subject.mathematics', ['পরিসংখ্যান', 'सांख्यिकी']),
