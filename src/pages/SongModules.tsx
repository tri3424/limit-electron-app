	...
	return (
		<div className="max-w-7xl mx-auto space-y-6">
			...
			<div className="space-y-4">
				{(modules ?? []).map((m) => (
					<Card key={m.id} className="flex items-stretch justify-between px-6 py-6 min-h-[104px] rounded-xl shadow-sm hover:shadow-md transition-shadow bg-green-50 border border-green-200">
						<div className="flex-1 pr-6 min-w-0">
							<h3 className="text-4xl font-semibold leading-tight text-foreground truncate">{m.title}</h3>
