				...
				<DialogContent className="max-w-2xl">
					...
					{previewSong ? (
						<div className="space-y-4">
							...
							<AudioPlayer src={previewSong.audioFileUrl} trackTitle={previewSong.title} />
							<div>
											...
											<div className="grid grid-cols-12 bg-muted px-3 py-2 text-xs font-medium">
												...
												<Tooltip>
													<TooltipTrigger asChild>
														<div className="col-span-1 text-right">On screen</div>
													</TooltipTrigger>
													<TooltipContent>Time spent on the song screen (even if audio was not playing)</TooltipContent>
												</Tooltip>
												<Tooltip>
													<TooltipTrigger asChild>
														<div className="col-span-2 text-right">Audio played</div>
													</TooltipTrigger>
													<TooltipContent>Estimated time the audio was actually playing</TooltipContent>
												</Tooltip>
											</div>
											<div className="divide-y">
												{listeningRows.map((r) => (
													...
													>
														<Tooltip>
															<TooltipTrigger asChild>
																<div className="col-span-4 truncate">{r.username}</div>
															</TooltipTrigger>
															<TooltipContent>{r.username}</TooltipContent>
														</Tooltip>
														<Tooltip>
															<TooltipTrigger asChild>
																<div className="col-span-5 truncate">{r.songTitle}</div>
															</TooltipTrigger>
															<TooltipContent>{r.songTitle}</TooltipContent>
														</Tooltip>
