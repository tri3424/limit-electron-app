							...
							<div className="flex items-center justify-end gap-2">
								...
								>
									<Tooltip>
										...
										<TooltipContent>Refresh progress</TooltipContent>
									</Tooltip>
								</Button>
								<Button
									variant="ghost"
													...
													<div className="divide-y">
														{dayDetails.length ? dayDetails.map((d, idx) => (
															...
															>
																...
																<Tooltip>
																	<TooltipTrigger asChild>
																		<div className="col-span-3 truncate">{d.moduleTitle}</div>
																	</TooltipTrigger>
																	<TooltipContent>{d.moduleTitle}</TooltipContent>
																</Tooltip>
																...
																<div className="col-span-5">
																	<Tooltip>
																		...
																		<TooltipContent>Click to view full question</TooltipContent>
																	</Tooltip>
																	<div className="text-xs text-muted-foreground">
																		Answer: {d.userAnswer || '—'}
																	</div>
